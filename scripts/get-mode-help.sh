...
case "$KEY_TABLE" in
  ...
  *)
    ...
    echo "#[fg=colour244]Ctrl+ [#[fg=colour51]o#[default]:#[fg=colour51]sessions#[fg=colour244] | #[fg=colour46]t#[default]:#[fg=colour46]tabs#[fg=colour244] | #[fg=colour81]p#[default]:#[fg=colour81]panes#[fg=colour244] | #[fg=colour201]h#[default]:#[fg=colour201]move#[fg=colour244] | #[fg=colour220]n#[default]:#[fg=colour220]resize#[fg=colour244]]"
    ;;
esac
